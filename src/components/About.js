  ...
  return (
    <div className="about-page">
      ...
      <div className="practitioners">
        ...
        <p>
          Sean A. Chun lives in Wailua and is currently employed by Ho`ola Lahui
          Hawai`i as the Native Hawaiian Traditional Healing Practitioner. He is
          also the po`o of the Kaua`i Kupuna Council of Traditional Hawaiian
          Healing Arts and sits on the `Aha Kukakuka Ho`oponopono Board as well
          as the Board of Kahuna La`au Lapa`au o Hawai`i. He has learned various
          arts and cultural practices. He credits his mentors and teachers such
          as Pila Kikuchi, Ilei Beniamina, Kumu Levon Ohai, Ken “Coach” Kamakea,
          Papa Francis Wong, Papa Tom Takahashi, Aunty Mahi Poepoe, Aunty Daisy
          Nash, Sensei Paul Yamaguchi, `Olohe Jerry Walker, and Sensei Bruce
          Keaulani.
        </p>
        ...
        <p>
          Maco Wai`ale`ale has owned and operated her massage clinic for more
          than 40 years. Maco is the vice president of Pihana ka `Ikena. She was
          a student of Aunty Margaret Machado, Papa Henry Auwae, Kumu Levon
          Ohai, Papa Kalua kaiahua, Aunty Malia Craver, and Aunty Daisy Nash.
        </p>

        <h4 className="board-section-header">Gwen Cardejon</h4>
        <p>
          Gwen Cardejon was a student of Aunty Mahi Poepoe and carries on the
          tradition of lomilomi kua lua. She was also a student of Papa Tom
          Takahashi.
        </p>
